...
#define LIBRARIES_PERIPHDRIVERS_INCLUDE_MAX32672_LP_H_
...
/**
 * @brief Enable the analog comparators as wakeup sources from low-power modes.
 */
void MXC_LP_EnableComparatorWakeup(mxc_adc_comp_t comp);

/**
 * @brief Disable the analog comparators as wakeup sources from low-power modes.
 */
...
#endif // LIBRARIES_PERIPHDRIVERS_INCLUDE_MAX32672_LP_H_
